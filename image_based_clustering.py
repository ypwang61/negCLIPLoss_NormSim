...
if __name__ == "__main__":
    ...
    #     sample_ratio=sample_ratio,
    # )
    embeddings_path = os.path.join(args.files_path, args.dataset_name, 'save', f"embeddings_f{args.fraction}.pt")
    if not os.path.exists(embeddings_path):
        raise FileNotFoundError(f"embeddings_path = {embeddings_path} not found!")
    ...
    print(f'clustering done in {time() - start:.2f}s')